...
class LineageContextEncoder:
    ...
    def __init__(
        ...
        lineages = sorted(set(cell_line_to_lineage.values()) | {unknown_label})  # stable indices
    ...
    def encode(self, cell_line_id: str) -> int:
        lineage = self.cell_line_to_lineage.get(cell_line_id, self.unknown_label)  # OOD -> unknown
